...
cv_inds[[10]]=inds
save(cv_inds,file="cv_inds.Rdata")

#__________________10-Fold CV for Empirical estimatation___________________
...
save(empirical_probs,file="empirical_probs-CV.Rdata")
