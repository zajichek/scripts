...
#Project: Kaggle March Madness Competition 2020
...
save(cv_results, file = str_c(root, "MM2020_cv_results.RData"))
...
final_models <-
  ...
  map(
    function(.x) {
      ...
      temp_dat <- model_dat %>% pluck(.x$Tourney)
